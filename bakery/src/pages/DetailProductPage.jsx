    ...
    <article className="max-w-6xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <section className="flex flex-col gap-6 order-2 md:order-1">
          ...
          {/* Precio del producto */}
          <p className="text-base md:text-lg lg:text-xl text-(--color-primary) font-semibold">
          ...
          <div className="flex gap-4 pt-4">
            <button className="px-6 py-3 bg-(--color-primary) text-white rounded-lg font-semibold hover:bg-(--color-secondary) hover:text-(--color-primary) transition-colors duration-300">
              Añadir al carrito
            </button>
          </div>
        </section>
